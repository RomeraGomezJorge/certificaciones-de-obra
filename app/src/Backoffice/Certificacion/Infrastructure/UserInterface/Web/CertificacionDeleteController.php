<?php
	...
	{
		public function __invoke(Request $request, CertificacionDeleter $deleter, ValidationRulesToDelete $rulesToDelete): JsonResponse
		{
		...
		private function delete(CertificacionDeleter $deleter, string $id): array
		{
			$deleter->__invoke($id);
