<?php
	...
	namespace App\Backoffice\CertificacionObra\Infrastructure\Persistence;
	...
	final class MySqlCertificacionObraRepository extends DoctrineRepository implements CertificacionObraRepository
	{
		const NOT_SETTING_VALUE = null;
		const ENTITY_CLASS = CertificacionObra::class;
