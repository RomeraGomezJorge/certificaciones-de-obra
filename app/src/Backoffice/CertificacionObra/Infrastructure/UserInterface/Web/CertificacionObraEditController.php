...
class CertificacionObraEditController extends WebController
{
	...
	): Response
	{
		...
		return $this->render(TwigTemplateConstants::FORM_FILE_PATH, [
            ...
            'fechaInicioObra'                 => $flashSession->get('inputs.fechaInicioObra') ?? $certificacionObra->getFechaInicioObra(),
            ...
            'anticipoFinancieroProvincia' => $flashSession->get('inputs.anticipoFinancieroProvincia') ?? $certificacionObra->getanticipoFinancieroProvincia(),
