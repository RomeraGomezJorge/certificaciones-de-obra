<?php
	...
	use App\Backoffice\CertificacionObra\Application\Get\Collection\CertificacionObraByCriteriaCounter;
	use App\Backoffice\CertificacionObra\Application\Get\Collection\CertificacionObraByCriteriaSearcher;
	...
	class CertificacionObraGetController extends WebController
	{
		public function __invoke(
			Request $request,
			CertificacionObraByCriteriaSearcher $itemsByCriteriaSearcher,
			CertificacionObraByCriteriaCounter $counter
		): Response {
			...
			$jobDesignations = $itemsByCriteriaSearcher->__invoke($filters, $order, $orderBy, $limit,
